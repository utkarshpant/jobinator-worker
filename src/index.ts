			...
			messages: [
				{
					role: 'system',
					content:
						"You're a knowledgeable recruiter in the tech industry in the US, where the user is applying for jobs. \
					...
					Both the resume and the reference document have been parsed into valid JSON, so assume that the camelCase is a JSON artifact. \
